...
from server.Exceptions.exceptions import CategoryNotFoundException, CategoryAlreadyExistsException
...
class CategoryService(ICategoryService):
    ...
    def create_category(self, category: CategoryCreate) -> dict:
        ...
        if existing:
            raise CategoryAlreadyExistsException(f"Category '{category.category_name}' already exists")
    ...
    def update_category(self, category_id: int, name: str = None, description: str = None) -> dict:
        ...
        if name and name != existing['name']:
            ...
            if name_conflict:
                raise CategoryAlreadyExistsException(f"Category '{name}' already exists")
