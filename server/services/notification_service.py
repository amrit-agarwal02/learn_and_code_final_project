...
from server.services.interfaces.notification_interface import INotificationService
...
class NotificationService(INotificationService):
    ...
    def save_user_notification_setting(self, user_id, notification_setting_data: NotificationRequest):
        category = notification_setting_data.category
        category_id = self.category_repo.get_id_by_name(category)['category_id']
        return self.notification_repo.save(user_id,category_id,notification_setting_data)
